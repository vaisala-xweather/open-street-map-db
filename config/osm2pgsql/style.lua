...
themepark:add_topic('xweather_shortbread_v1/bridges')
...
themepark:add_topic('xweather_shortbread_v1/railways')
themepark:add_topic('shortbread_v1/sites')  -- Campuses, school areas, parking lots, etc.
themepark:add_topic('xweather_shortbread_v1/streets')
themepark:add_topic('xweather_shortbread_v1/water')
